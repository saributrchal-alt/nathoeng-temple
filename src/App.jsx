...
// 🛡️ กำหนดรายชื่อ LINE UID ของผู้ดูแลระบบตัวจริงเท่านั้น
const ADMIN_LINE_UIDS = ['Ucce7f0e73af42c1c1443c328d6e59cba']; 
// (ถ้ามี LINE UID ของบัญชีแอดมินอื่นๆ เพิ่มเติม สามารถนำมาใส่เพิ่มในวงเล็บนี้ได้ครับ)
    ...
    <div className="site">
      ...
      <main>
        {currentPage === 'home' ? (
          ...
          // 🛡️ ป้องกันความปลอดภัยเข้มงวด: ตรวจสอบว่า UID ตรงกับแอดมินหรือไม่ หากไม่ใช่จะบล็อกทันที
